...
context('그룹 모집 페이지', () => {
  ...
  describe('그룹 검색', () => {
    ...
    it('기술스택 검색 필터링 기능이 정상적으로 동작한다.', () => {
      cy.intercept('GET', '/api/group/?page=1&techstack=typescript', {
        fixture: 'recruit/techstack-typescript.json',
      });
      ...
      cy.intercept('GET', '/api/group/?page=1&techstack=C%2B%2B', {
        fixture: 'recruit/techstack-C++.json',
      });
